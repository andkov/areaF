...
# cat("Working directory: ", getwd()) # check where you are
  library(knitr)
# Rmd is in "./reports/basic/basic.Rmd", but now the root is "./"
...
read_chunk("./reports/basic/basic.R") 
```
...
```{r inspect_data, echo=TRUE, results='show', message=FALSE}
```
...
<!-- Basic graph view.   -->
```{r basic_graph, echo=TRUE, results='show', message=FALSE, fig.width=11,fig.height=5}
```
